            ...
            if(x < this.rows() && this.obj.end <= this.rows()){
                ...
                for(var y = 0 ; y < colsCount ; y++){
                    ...
                    if(col.type === 'boolean'){
                        ...
                        cell.innerHTML = '<a href="'+data[col.key].href+'" target="'+data[col.key].target+'">'+data[col.key].text+'</a>';
                    }
                ...
                if(col.key.length > 0){
                    ...
                    if(!this.hasCol(col.key)){
                        ...
                        if(JSTable.SUPPORTED_DATATYPES.indexOf(col.type) === -1){
                            this.log('JSTable.addColumn: Column '+col.key+' has Unsupported datatype: '+col.type+'. Default is used (string)','warning',true);
                            col.type = 'string';
